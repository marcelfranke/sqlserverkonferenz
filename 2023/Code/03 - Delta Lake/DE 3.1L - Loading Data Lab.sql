...
USING DELTA
*/
SELECT "View code to show solution!" AS Solution
...
-- MAGIC Use a CTAS statement to create a managed Delta table named **`item_lookup`** that extracts data from the **parquet** directory `${da.paths.datasets}/ecommerce/raw/item-lookup`
